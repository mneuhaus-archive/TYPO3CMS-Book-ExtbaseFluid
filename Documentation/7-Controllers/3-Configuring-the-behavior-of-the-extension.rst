...
$this->organizationRepository->findByStates(GeneralUtilityintExplode(',',$this->settings['allowedStates'])));``
...
function :class:`GeneralUtilityintExplode()`. We then pass on the

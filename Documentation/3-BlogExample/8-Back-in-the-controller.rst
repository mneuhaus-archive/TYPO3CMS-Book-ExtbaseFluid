...
::
	...
	public function initializeAction() {
		$this->blogRepository = GeneralUtilitymakeInstance('\MyVendor\BlogExample\Domain\Repository\BlogRepository');
		$this->administratorRepository = GeneralUtilitymakeInstance('\MyVendor\BlogExample\Domain\Repository\AdministratorRepository');
	}
